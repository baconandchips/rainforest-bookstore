...
const ORDER_TABLE = "Order-kxqgbbe53zgufc6zcochm32sj4-prod";
const ORDER_TYPE = "Order";
const BOOK_ORDER_TABLE = "BookOrder-kxqgbbe53zgufc6zcochm32sj4-prod"
...
exports.handler = async (event) => {
    try {
        let payload = event.prev.result; // get order details from aws lambda
        payload.order_id = uuidv4();

        // create a new order
        await createOrder(payload); // Create order using AWS DynamoDB or sdk
